...
const MCHID = '1745678705';
const API_V3_KEY = 'AFLbf4FesOIEydh2SV_HdFarAZGX1kxZ'; // APIv3密钥
const APPID = 'wxa7aa15e29e828df8';
const SERIAL_NO = '356B10A4AEE455ABD3209236CB689C019331178E'; // 证书序列号

const CERT_PATH = path.join(__dirname, '..', '..', 'DigeguiguiID', 'wxpay', '1745678705', 'apiclient_cert.pem');
const KEY_PATH = path.join(__dirname, '..', '..', 'DigeguiguiID', 'wxpay', '1745678705', 'apiclient_key.pem');
